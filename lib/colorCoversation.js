 ...
 * @async
 * @param {array} rgb - Der Kelvin-Wert, der konvertiert werden soll.
 * @returns {Promise<array>} - Ein Promise, das ein Objekt mit den HUE-Werten für Farbton, Sättigung und Helligkeit enthält.
 */
 ...
 * @returns {Promise<array>} - Ein Promise, das ein Objekt mit den RGB-Werten für Rot, Grün und Blau enthält.
 */
...
async function ConvertHexToHue(hex) {
	...
	const hue = await ConvertRgbToHue(rgb[0], rgb[1], rgb[2]);
