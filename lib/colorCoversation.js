 ...
 * @returns {number[]} Ein Array mit den HSL-Werten.
 */
 ...
 * @param {array} rgb - Der RGB-Wert, der konvertiert werden soll.
 * @returns {number[]} - Ein Promise, das ein Objekt mit den HUE-Werten für Farbton, Sättigung und Helligkeit enthält.
 */
 ...
 * @returns {number[]} - Ein Promise, das ein Objekt mit den RGB-Werten für Rot, Grün und Blau enthält.
 */
