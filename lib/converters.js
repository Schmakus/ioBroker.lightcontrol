 ...
 * @returns {number[]} Ein Array mit den RGB-Werten [rot, grün, blau].
 */
 ...
 * @typedef {Object} HUEData
 * @property {number} hue - Der HUE-Wert im Bereich von 0 bis 65535.
 * @property {number} saturation - Die Sättigung im Bereich von 0 bis 254.
 * @property {number} brightness - Die Helligkeit im Bereich von 0 bis 254.
 * @returns {HUEData} Ein Objekt mit den HUE-Werten. {hue, saturation, brightness}
 */
function ConvertKelvinToHue(kelvin) {
...
/**
 * Konvertiert HSV-Werte in RGB-Werte.
 * @param {number[]} hsv - Ein Array mit den HSV-Werten [Hue, Saturation, Value].
 * @typedef {number[]} RGBData - Ein Array mit den RGB-Werten [Rot, Grün, Blau].
 * @returns {RGBData} Ein Array mit den RGB-Werten.
 */
...
/**
 * Konvertiert einen RGB Farbwert in einen HSL-Wert.
 * @param {array} rgb - Der RGB-Wert, der konvertiert werden soll [rot ,grün ,blau]
 * @returns {number[]} Ein Array mit den HSL-Werten. [h,s,l]
 */
...
/**
 * Konvertiert einen RGB Farbwert in einen HSV-Wert.
 * @param {array} rgb - Der RGB-Wert, der konvertiert werden soll [rot ,grün ,blau]
 * @returns {number[]} Ein Array mit den HSV-Werten
 */
...
/**
 * Konvertiert einen RGB Farbwert in einen CMYK-Wert.
 * @param {array} rgb - Der RGB-Wert, der konvertiert werden soll [rot ,grün ,blau]
 * @returns {number[]} Ein Array mit den CMYK-Werten
 */
...
/**
 * Konvertiert einen RGB Farbwert in einen XYZ-Wert.
 * @param {array} rgb - Der RGB-Wert, der konvertiert werden soll. [rot ,grün ,blau]
...
/**
 * Konvertiert einen RGB WErt in einen XY-Farbwert.
 * @param {array} rgb - Der RGB-Wert, der konvertiert werden soll.
 * @returns {number[]} - Ein array mit den X und Y Werten
 */
...
/**
 * Konvertiert einen RGB WErt in einen LAB-Farbwert.
 * @param {array} rgb - Der RGB-Wert, der konvertiert werden soll.
 * @returns {number[]}
 */
...
/**
 * Konvertiert eine RGB-Farbe in den entsprechenden Hexadezimalwert.
 *
 * @param {number[]} rgb - Ein Array mit den RGB-Werten.
 * @returns {string} Der Hexadezimalwert der konvertierten Farbe.
 */
 ...
 * @returns {number[]} - Array mit den RGB-Werten für Rot, Grün und Blau enthält.
 */
 ...
 * @returns {number} - Der HUE-Wert (0-65535).
 */
function ConvertRgbToHue(red, green, blue) {
	const r = red / 255;
	const g = green / 255;
	const b = blue / 255;
 ...
 * @property {number} saturation - Die Sättigung im Bereich von 0 bis 254.
 * @property {number} brightness - Die Helligkeit im Bereich von 0 bis 254.
 * @returns {HUEData} Ein Objekt mit den HUE-Werten.
 */
function ConvertHexToHue(hex) {
